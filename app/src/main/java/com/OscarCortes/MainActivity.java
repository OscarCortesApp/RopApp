...
public class MainActivity extends AppCompatActivity {
    ...
    private void configureCheckHome() {
        ...
        configButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                startActivity(new Intent(Signin.this, Login));
            }
    ...
    private void configureCreateAccount() {
        Button createAccount = (Button) findViewById(R.id.accountButton);

        configButton.setOnClickListener(new View.OnClickListener() {

            @Override
            public void onClick(View view) {
                startActivity(new Intent(MainActivity.this, Signin));
            }
